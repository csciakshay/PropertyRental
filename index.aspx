...
WHERE ([psold] = @propertysold)">
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
     <asp:Label ID="Label5" runat="server" Text="Your Faveriote Property" Font-Size="Medium" Font-Bold="True"></asp:Label><br />
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
     <asp:Label ID="Label6" runat="server" Text="Most frequent viewed Property" Font-Size="Medium" Font-Bold="True"></asp:Label><br />
