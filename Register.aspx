...
<h2>Register</h2>
    ...
    <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" 
        ContinueDestinationPageUrl="~/index.aspx" Height="350px" 
        Width="384px" CancelDestinationPageUrl="~/index.aspx" 
        ...
        <MailDefinition BodyFileName="~/EmailTemplate.htm" IsBodyHtml="True" 
            Priority="High" 
            
            
            Subject="[VU-Online Real Estate System] Steps to activate your new account...">
        </MailDefinition>
        <WizardSteps>
            <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server" Title="">
                <ContentTemplate>
                    <table style="font-size:100%;height:350px;width:386px;">
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                    ControlToValidate="Email" ErrorMessage="Invalid E-Mail" 
                                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                                    ValidationGroup="CreateUserWizard1" CssClass="ErrorMsgBox"> </asp:RegularExpressionValidator>
                                      <br /> 
